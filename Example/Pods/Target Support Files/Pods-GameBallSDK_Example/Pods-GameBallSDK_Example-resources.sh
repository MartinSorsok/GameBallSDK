...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ChallengeDetails/ChallengeDetailsHeaderCell/ChallengeDetailsHeaderCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ChallengeDetails/ChallengeDetailsViewController/ChallengeDetailsViewController.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ChallengeDetails/HighScoreTableViewCell/HighScoreTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ChallengeDetails/ProgressBarTableViewCell/ProgressBarTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ChallengeDetails/StatusTableViewCell/StatusTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/Challenges/BadgesCollectionViewinCell/BadgesCollectionViewinCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/Challenges/BadgeView/BadgeView.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ChallengesTableViewInCell/ChallengesTableViewInCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/CustomViews/HeaderCollectionReusableView/HeaderCollectionReusableView.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/CustomViews/NotificationPopUP/NotificationPopUPView.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/CustomViews/TabbarCell/TabbarCollectionViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/CustomViews/TabIconsHeader/TabIconsHeader.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/FriendReferal/ReferalFriendTableViewCell/ReferalFriendTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/FriendReferal/ReferalHeaderView/ReferalHeaderViewTableView.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/Leaderboard/LeaderBoardHeaderView/LeaderBoardHeaderView.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/Leaderboard/LeaderBoardTableViewCell/LeaderBoardTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/Notifications/NotificationsHeaderView/NotificationsTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/Notifications/NotificationsTableViewCell/NotificationHeaderView.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ParentViewController/ParentViewController.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ProfileHeader/MainTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../GameBallSDK/Resources/Modules/ProfileHeader/ProfileHeaderView.xib"
fi
